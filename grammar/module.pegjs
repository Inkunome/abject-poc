...
FacetToken      = "facet"      !IdentifierPart
...
DefineToken     = "define"     !IdentifierPart
DefineOnToken   = "define" __ "on"  !IdentifierPart
...
TupleLiteral
  = "(" __ head:AssignmentExpression  __ "," __ ")" {
      return {
        type: "TupleExpression",
        elements: [head]
      };
    }
  / "(" __ head:AssignmentExpression tail:(__ "," __ AssignmentExpression)* __ ")" {
      return {
        type: "TupleExpression",
...
ProjectionExpression
  = head:PrimaryExpression
    tail:(
      ...
      / __ "->" __ property:IdentifierName {
          return { property, kind: "dispatch" };
        }
      / __ "~>" __ property:IdentifierName {
          return { property, kind: "pure" };
        }
    )*
    {
      return tail.reduce(function(result, element) {
...
DefineDeclaration
  = DefineOnToken __ receiver:Identifier __ id:Identifier __
    "(" __ params:(FormalTypedParameterList __)? ")" __
    ":" __ ret:Identifier __
    "{" __ body:FunctionBody __ "}"
    {
      return {
  ...
  / DefineToken __ id:Identifier __
    "(" __ params:(FormalTypedParameterList __)? ")" __
    ":" __ ret:Identifier __
    "{" __ body:FunctionBody __ "}"
    {
...
FacetDeclaration
  = FacetToken __ id:Identifier __
    "(" __ params:(FormalTypedParameterList __)? ")" __
    ":" __ ret:Identifier __ ";"
    {
      return {
...
ModelDeclaration
  = ModelToken __ id:Identifier __
    "{" fields:(__ FormalTypedParameter __ ";")* __ "}"
    {
      return {
        type: "ModelDeclaration",
        id,
        fields: extractList(fields, 1),
      };
    }
...
FormalTypedParameterList
  = head:FormalTypedParameter tail:(__ "," __ FormalTypedParameter)* {
      return buildList(head, tail, 3);
    }

FormalTypedParameter
  = id:Identifier __ ":" __ type:Type {
      return { name: id.name, type }
    }

Type
  = simple:SimpleType array:(__ "[]")* {
